...
| -------- | ----------- | -------- | ---- |
| [Batch-mode](./Datasets.ipynb) | Process your collected log datasets using the Batch API. | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/google-gemini/cookbook/blob/main/examples/Datasets.ipynb) |
