...
| [Outfit Assistant](./Outfit_Assistant.ipynb) | Use Gemini's multimodality to recommend outfits based on style preference, occasion, and weather data. | Multimodal, Grounding | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/google-gemini/cookbook/blob/main/examples/Outfit_Assistant.ipynb) |
