...
| Grounding | Learn how to ground Gemini model responses with Google Search, YouTube, and live web URLs for up-to-date, verifiable information. | Search grounding, YouTube/video context, URL context, factual accuracy | [![Open in AI Studio](https://storage.googleapis.com/generativeai-downloads/images/Open_in_AIStudio.svg)](https://aistudio.google.com/apps/bundled/grounding?showPreview=true) | <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" alt="JS" width="20"/> [Grounding.js](./Grounding.js) |
