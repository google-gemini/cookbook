...
* [SQL Agent using Gemini API and LangChain](https://github.com/google-gemini/cookbook/blob/main/examples/langchain/SQL_Agent_Gemini_LangChain.ipynb): Build an autonomous SQL Agent that answers natural language questions about a SQLite database using Gemini API and LangChain.
