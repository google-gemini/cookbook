...
| [Email Concierge Bot](./Email_Concierge_Bot.ipynb) | Build a smart assistant that classifies emails using embeddings and function calling | Embeddings, Function calling, Interactive memory | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/google-gemini/cookbook/blob/main/examples/Email_Concierge_Bot.ipynb) |
