...
* When selecting a model, use a colab selector for easier maintainability:
  `MODEL_ID="gemini-2.5-flash" # @param ["gemini-2.5-flash-lite", "gemini-2.5-flash", "gemini-2.5-pro", "fiercefalcon", "gemini-3-pro-preview"] {"allow-input":true, isTemplate: true}`
