...
* When selecting a model, use a Colab form selector for easier maintainability:
    ```python
    MODEL_ID="gemini-3-flash-preview" # @param ["gemini-2.5-flash", "gemini-2.5-pro", "gemini-3.1-flash-lite", "gemini-3-flash-preview", "gemini-3.1-pro-preview"] {"allow-input":true, isTemplate: true}
    ```
