...
| [Virtual Try-on](./Pdf_structured_outputs_on_invoices_and_forms.ipynb) | A Virtual Try-On application that uses Gemini 2.0 for 2D object detection to identify outfits in images and Imagen 3 for generating and inpainting new outfits. | Spatial Understanding | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/google-gemini/cookbook/blob/main/examples/Virtual_Try_On.ipynb) |
