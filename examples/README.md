...
| -------- | ----------- | -------- | ---- |
| [Processing datasets with the Batch API](./Datasets.ipynb) | Process your collected log datasets using the Batch API. | Batch API, Datasets | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/google-gemini/cookbook/blob/main/examples/Datasets.ipynb) |
...
| [Batching and chunking](./batching_and_chunking.ipynb) | Make API calls to Gemini more efficient | Tools, Efficient Processing | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/google-gemini/cookbook/blob/main/examples/batching_and_chunking.ipynb) |
